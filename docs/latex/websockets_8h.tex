...
\item 
struct \mbox{\hyperlink{structws__info}{ws\+\_\+info}}
\item 
...
bool \mbox{\hyperlink{websockets_8h_a0984231cfbfede5def311aacce707779}{ws\+\_\+send\+\_\+binary}} (struct websockets $\ast$ws, struct \mbox{\hyperlink{structws__info}{ws\+\_\+info}} $\ast$info, const char msg\mbox{[}$\,$\mbox{]}, size\+\_\+t msglen)
\begin{DoxyCompactList}\small\item\em Send a binary message of given size. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{websockets_8h_a317a2eeff2ac2c04752e1990910ec902}{ws\+\_\+send\+\_\+text}} (struct websockets $\ast$ws, struct \mbox{\hyperlink{structws__info}{ws\+\_\+info}} $\ast$info, const char text\mbox{[}$\,$\mbox{]}, size\+\_\+t len)
\begin{DoxyCompactList}\small\item\em Send a text message of given size. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{websockets_8h_a75b6ebdc56cbb00850d9d848cce238be}{ws\+\_\+ping}} (struct websockets $\ast$ws, struct \mbox{\hyperlink{structws__info}{ws\+\_\+info}} $\ast$info, const char reason\mbox{[}$\,$\mbox{]}, size\+\_\+t len)
\begin{DoxyCompactList}\small\item\em Send a P\+I\+NG (opcode 0x9) frame with {\itshape reason} as payload. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{websockets_8h_a05815c7f0d0a923afd7f0e96c2411131}{ws\+\_\+pong}} (struct websockets $\ast$ws, struct \mbox{\hyperlink{structws__info}{ws\+\_\+info}} $\ast$info, const char reason\mbox{[}$\,$\mbox{]}, size\+\_\+t len)
\begin{DoxyCompactList}\small\item\em Send a P\+O\+NG (opcode 0xA) frame with {\itshape reason} as payload. \end{DoxyCompactList}\item 
...
\end{DoxySeeAlso}
\mbox{\Hypertarget{websockets_8h_a75b6ebdc56cbb00850d9d848cce238be}\label{websockets_8h_a75b6ebdc56cbb00850d9d848cce238be}} 
\index{websockets.h@{websockets.h}!ws\_ping@{ws\_ping}}
\index{ws\_ping@{ws\_ping}!websockets.h@{websockets.h}}
\doxysubsubsection{\texorpdfstring{ws\_ping()}{ws\_ping()}}
{\footnotesize\ttfamily bool ws\+\_\+ping (\begin{DoxyParamCaption}\item[{struct websockets $\ast$}]{ws,  }\item[{struct \mbox{\hyperlink{structws__info}{ws\+\_\+info}} $\ast$}]{info,  }\item[{const char}]{reason\mbox{[}$\,$\mbox{]},  }\item[{size\+\_\+t}]{len }\end{DoxyParamCaption})}



Send a P\+I\+NG (opcode 0x9) frame with {\itshape reason} as payload. 


\begin{DoxyParams}{Parameters}
{\em ws} & the Web\+Sockets handle created with \mbox{\hyperlink{websockets_8h_a4ff8bbffc8cf3172ff02f5233315796b}{ws\+\_\+init()}} \\
\hline
{\em info} & get information on how this transfer went \\
\hline
{\em reason} & N\+U\+LL or some U\+T\+F-\/8 string null (\textquotesingle{}\textbackslash{}0\textquotesingle{}) terminated. \\
\hline
{\em len} & the length of {\itshape reason} in bytes. If S\+I\+Z\+E\+\_\+\+M\+AX, uses strlen() on {\itshape reason} if it\textquotesingle{}s not N\+U\+LL. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
true if sent, false on errors. 
\end{DoxyReturn}
\mbox{\Hypertarget{websockets_8h_a05815c7f0d0a923afd7f0e96c2411131}\label{websockets_8h_a05815c7f0d0a923afd7f0e96c2411131}} 
\index{websockets.h@{websockets.h}!ws\_pong@{ws\_pong}}
\index{ws\_pong@{ws\_pong}!websockets.h@{websockets.h}}
\doxysubsubsection{\texorpdfstring{ws\_pong()}{ws\_pong()}}
{\footnotesize\ttfamily bool ws\+\_\+pong (\begin{DoxyParamCaption}\item[{struct websockets $\ast$}]{ws,  }\item[{struct \mbox{\hyperlink{structws__info}{ws\+\_\+info}} $\ast$}]{info,  }\item[{const char}]{reason\mbox{[}$\,$\mbox{]},  }\item[{size\+\_\+t}]{len }\end{DoxyParamCaption})}



Send a P\+O\+NG (opcode 0xA) frame with {\itshape reason} as payload. 

Note that pong is sent automatically if no \char`\"{}on\+\_\+ping\char`\"{} callback is defined. If one is defined you must send pong manually.
...
true if sent, false on errors. 
\end{DoxyReturn}
\mbox{\Hypertarget{websockets_8h_a0984231cfbfede5def311aacce707779}\label{websockets_8h_a0984231cfbfede5def311aacce707779}} 
\index{websockets.h@{websockets.h}!ws\_send\_binary@{ws\_send\_binary}}
\index{ws\_send\_binary@{ws\_send\_binary}!websockets.h@{websockets.h}}
\doxysubsubsection{\texorpdfstring{ws\_send\_binary()}{ws\_send\_binary()}}
{\footnotesize\ttfamily bool ws\+\_\+send\+\_\+binary (\begin{DoxyParamCaption}\item[{struct websockets $\ast$}]{ws,  }\item[{struct \mbox{\hyperlink{structws__info}{ws\+\_\+info}} $\ast$}]{info,  }\item[{const char}]{msg\mbox{[}$\,$\mbox{]},  }\item[{size\+\_\+t}]{msglen }\end{DoxyParamCaption})}



Send a binary message of given size. 

Binary messages do not need to include the null terminator (\textbackslash{}0), they will be read up to {\itshape msglen}.
...
{\em info} & get information on how this transfer went \\
\hline
{\em msg} & the pointer to memory (linear) to send. \\
\hline
{\em msglen} & the length in bytes of {\itshape msg}. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
true if sent, false on errors. 
\end{DoxyReturn}
\mbox{\Hypertarget{websockets_8h_a317a2eeff2ac2c04752e1990910ec902}\label{websockets_8h_a317a2eeff2ac2c04752e1990910ec902}} 
...
{\footnotesize\ttfamily bool ws\+\_\+send\+\_\+text (\begin{DoxyParamCaption}\item[{struct websockets $\ast$}]{ws,  }\item[{struct \mbox{\hyperlink{structws__info}{ws\+\_\+info}} $\ast$}]{info,  }\item[{const char}]{text\mbox{[}$\,$\mbox{]},  }\item[{size\+\_\+t}]{len }\end{DoxyParamCaption})}
